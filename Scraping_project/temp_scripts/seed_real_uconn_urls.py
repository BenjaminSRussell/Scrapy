#!/usr/bin/env python
"""Seed real UConn URLs for testing the pipeline

This script seeds the pipeline with real UConn.edu URLs across different categories
...
def seed_real_uconn_urls():
    """Seed real UConn URLs for comprehensive testing."""

    # Real UConn URLs across different sections
    real_urls = [
        # Main pages
        "https://uconn.edu/",
    ...
    try:
        result = seed_manager.add_urls_to_seeds(
            ...
            enqueue_stage2=False  # Scout will queue them
        )
