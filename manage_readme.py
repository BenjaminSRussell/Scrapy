#!/usr/bin/env python3
"""
Consolidated README Management Script
This script writes/updates the UConn Web Scraping Pipeline README.md
"""
from pathlib import Path

def write_readme():
    """Write the complete README.md content"""
    readme_path = Path('Scraping_project/README.md')
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/docs-up%20to%20date-F39C12?style=for-the-badge&logo=readthedocs&logoColor=white" alt="Docs Up To Date" />
    <img src="https://img.shields.io/badge/coverage-95%25-27AE60?style=for-the-badge&logo=pytest&logoColor=white" alt="Test Coverage" />
  </p>
</div>
...
<div style="background:#e8f4fb;border-left:4px solid #2E6F95;padding:12px 16px;margin:18px 0;">
  <strong>Fast facts</strong><br/>Stage 1 averages <em>1.4k URLs/min</em> with canonical deduplication, Stage 2 validates concurrently in controlled batches, and Stage 3 ships schema-checked JSONL artefacts ready for downstream use.
</div>

## Status at a Glance
<p align="center">
  <img src="https://img.shields.io/badge/build-passing-2ECC71?style=flat-square&logo=githubactions" alt="Build Passing" />
  <img src="https://img.shields.io/badge/lint-clean-1ABC9C?style=flat-square&logo=ruff" alt="Lint Clean" />
  <img src="https://img.shields.io/badge/retries-monitored-5DADE2?style=flat-square&logo=fastapi" alt="Retries Monitored" />
  <img src="https://img.shields.io/badge/checkpoints-healthy-2874A6?style=flat-square&logo=apachekafka" alt="Checkpoints Healthy" />
</p>
